...
const SideBar = () => {
  ...
  return (
    <Fragment>
      ...
      />
      <Sider breakpoint="lg" collapsedWidth={0} width={SIDER_WIDTH}>
        <div
          style={{
            padding: "1em",
            textAlign: "center",
        ...
        >
          <LargeAnchorTag href="https://charitybase.uk">
            CharityBase
          </LargeAnchorTag>
          <LogInOrOut
        ...
        >
          <a href="https://twitter.com/charitybase_uk">
            <TwitterIcon width="2em" height="2em" fill="rgba(255,255,255,.8)" />
          </a>
        </div>
      </Sider>
    </Fragment>
